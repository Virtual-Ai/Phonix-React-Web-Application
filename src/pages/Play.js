...
function Cards() {
  ...
  <SectionTitle>What to play ?</SectionTitle>
    <div className="grid gap-6 mb-8 md:grid-cols-4">
      ...
      <Link to = "/app/play/quiz">
            <Card colored className="mb-8 shadow-md" style={{backgroundColor:"#66d4f9" ,position:"relative",borderRadius:'0.9rem'}}>
              <CardBody>
                  <img src={ob4} className="obs" alt="Image" style={{position:"absolute",height:"100%",left:"0",bottom:"0",maxHeight:'9.5rem',marginLeft:'0.2rem', marginBottom:'0.2rem'}}/>
                  <img src={mbSent} className="mb-obs" alt="Image" style={{position:"absolute",height:"100%",left: '-60px', bottom: '-52px',maxHeight: '12.5rem'}}/>

                  <h4 className="text-6xl font-chewy text-white text-right pl-cd-title" style={{}}>Sentence</h4>
                  <h4 className="text-5xl font-chewy text-white text-right pl-cd-byline">Builder</h4>
                  <h4 className="text-lg font-chewy text-white text-right mb-12 pl-cd-btmLine" style={{color:'#c2ecfb'}}>Tap here to begin</h4>
                  <div className="flex justify-end">
                      <img src={arrow} alt="Image" style={{maxWidth:'2.5rem'}}/>
                  </div>
      ...
      <Link to = "/app/play/quiz">
            <Card colored className="mb-8 shadow-md" style={{backgroundColor:"#f4bb14" ,position:"relative",borderRadius:'0.9rem'}}>
              <CardBody>
                  <img src={ob5} className="obs" alt="Image" style={{position:"absolute",height:"100%",left:"0",bottom:"0",maxHeight:'10.5rem',marginLeft:'0.2rem', marginBottom:'0.2rem'}}/>
                  <img src={mbMatch} className="mb-obs" alt="Image" style={{position:"absolute",height:"100%",left: '-52px', bottom: '-52px',maxHeight: '12.5rem'}}/>

                  <h4 className="text-6xl font-chewy text-white text-right pl-cd-title" style={{}}>Matching</h4>
                  <h4 className="text-5xl font-chewy text-white text-right pl-cd-byline">Pairs</h4>
                  <h4 className="text-lg font-chewy text-white text-right mb-12 pl-cd-btmLine" style={{color:'#fbf0d0'}}>Tap here to begin</h4>
                  <div className="flex justify-end">
                      <img src={arrow} alt="Image" style={{maxWidth:'2.5rem'}}/>
                  </div>
