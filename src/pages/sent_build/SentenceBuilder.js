    ...
    render() {
        ...
        try {
            if (
                ...
                if (this.state.rows.length === data[this.state.counter].split(' ').length) {
                    this.wrongA.play()
                    ...
                    <div className="flex justify-center	mb-4 pb-4 tablet:text-sm   ">
                        <div className="tablet:ml-0">
                            ...
                            <div className="">
                                ...
                                <div className="flex" style={{alignItems: "center", marginTop: "50px"}}>
                                    {this.state.counter === 0 ? <img width="75px" style={{height: "75px"}}
                                                                     src={require("./assets/pre.png")}/> :
                                    <img onClick={this.onPreviousClick} width="75px" style={{height: "75px"}}
                                         src={require("./assets/pre.png")}/>}
                                    <div
                                        ref={this.addDraggable}
                                    ...
                                    <img onClick={this.onNextClick} style={{height: "75px"}} width="75px"
