...
const questions = [  
      {
          ...
          answers: [
             { answerText: "Tom a lot of people invited.", isCorrect: false, imgSrc: A},
            { answerText:"A lot of people Tom invited.", isCorrect: false,imgSrc: B },
            { answerText:"Tom invited a lot of people.", isCorrect: true, imgSrc: C},
            { answerText:"Tom invited of people a lot.", isCorrect: false, imgSrc: D},
          ],
...
setShowExpln(true) 
  ...
  const OptionsBelow = () => {
    return(
      ...
      <button className = "m4 align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none px-10 py-4 rounded-lg text-gray-600 border-gray-300 border dark:text-gray-400 focus:outline-none active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:shadow-outline-gray" onClick = {() => SkipQuestion()}>Skip</button>
      <button className = "m4 align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none px-10 py-4 rounded-lg text-white bg-purple-600 border border-transparent active:bg-purple-600 hover:bg-purple-700 focus:shadow-outline-purple" onClick = {() => NextQuestion()}>Next</button>
      </div>
    )
  }
...
<div className="layout-instructions">
  ...
  <img className = "instrucImage2" src={require("./assets/happy.png")} alt="instruc-image"/>
  </div>
</div>
				</>
			)}
